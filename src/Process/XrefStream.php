...
abstract class XrefStream extends \Com\Tecnick\Pdf\Parser\Process\RawObject
{
            ...
            for ($idx = 1; $idx <= $columns; ++$idx) {
                ...
                switch ($predictor) {
                    ...
                    case 14:
                        ...
                        $this->minDistance($ddata, $row, $idx, $jdx, $row_left, $row_up, $row_upleft, $key);
                        break;
                    default:
     ...
     */
    protected function minDistance(&$ddata, $row, $idx, $jdx, $row_left, $row_up, $row_upleft, $key)
    {
        // initial estimate
    ...
    protected function processXrefType(
        ...
        foreach ($sarr as $key => $val) {
            ...
            $this->processXrefTypeFt($val[1], $sarr, $xref, $filltrailer, $key);
        }
    }
     ...
     * @param bool   $filltrailer
     */
    protected function processXrefTypeFt($type, $sarr, &$xref, $filltrailer, $key)
    {
        if (!$filltrailer) {
            return;
        }
        switch ($type) {
            ...
            case 'ID':
                ...
                break;
            default:
                $this->processXrefObjref($type, $sarr, $xref, $key);
                break;
        }
    }
     ...
     * @param array  $xref
     */
    protected function processXrefObjref($type, $sarr, &$xref, $key)
    {
